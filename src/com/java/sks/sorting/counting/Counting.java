package com.java.sks.sorting.counting;
...
public class Counting {
    public int[] countingSort(int[] arr, int k) {
        /**
         * 'k' happens to be 1 + max number in given array.
         *
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sorted array: " + Arrays.toString(new Counting().countingSort(array, 146)));
    }
}
